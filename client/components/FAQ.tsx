    ...
    <section className="py-32 bg-background relative" id="faq">
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/60">Everything you need to know about MarQet.</p>
        </div>
          ...
          {faqs.map((faq, index) => {
            ...
            return (
              <motion.div 
                ...
                className={`border rounded-2xl overflow-hidden transition-colors duration-300 ${isOpen ? "bg-white/5 border-white/20" : "bg-transparent border-white/10 hover:border-white/20"}`}
              >
                <button
                ...
                >
                  ...
                  <motion.div
                    ...
                    className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${isOpen ? "bg-primary text-white" : "bg-white/10 text-white"}`}
                  >
                ...
                <AnimatePresence>
                  {isOpen && (
                    <motion.div
                      ...
                      transition={{ duration: 0.3 }}
                    >
                      <div className="p-6 pt-0 text-lg text-white/60 leading-relaxed">
                        {faq.a}
                      </div>
                    </motion.div>
                  )}
