...
import { ArrowRight, Mail, Lock, Store } from "lucide-react";
        ...
        <div className="backdrop-blur-2xl bg-card/40 border border-white/10 p-8 rounded-[2rem] shadow-2xl relative overflow-hidden">
          ...
          <form onSubmit={handleLogin} className="space-y-6 relative z-10">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-black/20 border border-white/5 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all text-foreground"
            ...
            <motion.button 
              ...
              type="submit" 
              disabled={isLoading}
              className="w-full py-3.5 px-4 text-white font-semibold rounded-xl transition-all flex items-center justify-center gap-2 group disabled:opacity-50 disabled:cursor-not-allowed bg-emerald-500 shadow-[0_0_20px_rgba(16,185,129,0.4)]"
            >
